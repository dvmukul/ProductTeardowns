...
What is this product, who is it for, and what's the competitive context? No fluff — just the facts that matter for strategic orientation.

**2. Core Jobs-to-be-Done**
The functional and emotional jobs users are hiring this product to do. This is where most product analyses go shallow. I try to go one level deeper: what's the job *behind* the job?

**3. Key UX Decisions & Why**
Specific design choices, with hypotheses about the reasoning behind them. Onboarding, core loops, friction points, and the moments where you can see the PM's fingerprints.

**4. Business Model Mechanics**
How the product makes money, how it acquires users, and what the retention engine actually is. Because features don't exist in isolation — they exist to serve a business model.

**5. Recommendations & Strategic Risks**
If I were the PM: what would I ship next, what would I be scared of, and where is the AI-native competitor going to attack first?

---

## A note on the AI lens
